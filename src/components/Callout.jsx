...
const styles = {
  note: {
    ...
    body: 'text-indigo-800 prose-code:text-indigo-900 dark:text-slate-300 dark:prose-code:text-slate-300 prose-a:text-indigo-900 [--tw-prose-background:theme(colors.sky.50)]',
  },
  warning: {
    container:
