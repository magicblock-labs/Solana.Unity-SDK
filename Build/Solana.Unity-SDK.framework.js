...
async function _ExternConnectXNFT(callback) {
...
async function _ExternSignTransactionXNFT(transaction, callback) {
 if ("xnft" in window && window.xnft != null && window.xnft.solana != null) {
  try {
...
function _WebSocketConnect(instanceId) {
 ...
 instance.ws.onopen = function() {
  if (webSocketManager.debug) console.log("[JSLIB WebSocket] Connected.");
  if (webSocketManager.onOpen) Module["dynCall_vi"](webSocketManager.onOpen, instanceId);
 };
 instance.ws.onmessage = function(ev) {
  if (webSocketManager.debug) console.log("[JSLIB WebSocket] Received message: ", ev.data);
 ...
 instance.ws.onerror = function(ev) {
  if (webSocketManager.debug) console.log("[JSLIB WebSocket] Error occured.");
 ...
 instance.ws.onclose = function(ev) {
  if (webSocketManager.debug) console.log("[JSLIB WebSocket] Closed, Code: " + ev.code + ", Reason: " + ev.reason);
...
var asmLibraryArg = {
 ...
 "ExternConnectXNFT": _ExternConnectXNFT,
 "ExternCopyToPastebin": _ExternCopyToPastebin,
 "ExternSignTransaction": _ExternSignTransaction,
 "ExternSignTransactionXNFT": _ExternSignTransactionXNFT,
